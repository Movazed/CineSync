package com.example.cinesync.Activity;
...
import com.example.cinesync.Adapter.FilmListAdapter;
import com.example.cinesync.Domain.FilmItem;
import com.example.cinesync.Domain.ListFilm;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendRequest1() {
        ...
        mStringRequest=new StringRequest(Request.Method.GET,"https://moviesapi.ir/api/v1/movies?page=1",response ->{
            ...
            Log.i("arya", "sendRequest1: "+error.toString());
            loading1.setVisibility(View.GONE);
        });
